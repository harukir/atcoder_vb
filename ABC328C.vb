...
'        Dim sL As List(Of String) = splitBlank(S)

'        Dim ruiseki As New List(Of Decimal)

'        Dim beforeStr As String = ""
'        Dim beforeCnt As Decimal = 0
'        For i As Decimal = 0 To sL.Count - 1

'            If beforeStr = sL(i) Then
'                beforeCnt += 1
'            End If

'            ruiseki.Add(beforeCnt)
...
'            r.AppendLine((ruiseki(argD(1) - 1) - ruiseki(argD(0) - 1)).ToString)
