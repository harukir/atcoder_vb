...
'        Dim dicP As New Dictionary(Of Decimal, Decimal)
'        dicP.Add(0, 1)

'        Dim tempP As Decimal = 0

'        For i As Decimal = 0 To N - 2

'            tempP = (tempP + D(i)) Mod L

'            If dicP.ContainsKey(tempP) Then
'                dicP(tempP) += 1
'            Else
'                dicP.Add(tempP, 1)
'            End If
...
'        Dim henLength As Decimal = L / 3
'        Dim result As Decimal = 0

'        For i As Decimal = 0 To henLength - 1

'            Dim p1 As Decimal = If(dicP.ContainsKey(i), dicP(i), 0)
'            Dim p2 As Decimal = If(dicP.ContainsKey(i + henLength), dicP(i + henLength), 0)
'            Dim p3 As Decimal = If(dicP.ContainsKey(i + (henLength * 2)), dicP(i + (henLength * 2)), 0)
