...
'        Dim nowSum As Decimal = 0
'        Dim diff As New List(Of Decimal)

'        For i As Decimal = 0 To N - 1
'            Dim LR As Decimal() = in_dAry()
...
'        If isSuccess Then
'            ans.AppendLine("Yes")
'            ans.AppendLine(String.Join(" ", result))
'        Else
'            ans.Append("No")
'        End If

'        Console.WriteLine(ans.ToString.Trim)
