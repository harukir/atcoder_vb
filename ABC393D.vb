...
'        Dim oneP As New List(Of Decimal)

'        For i As Decimal = 0 To N - 1
'            If S.Substring(i, 1) = "1" Then oneP.Add(i)
'        Next

'        Dim centerP As Decimal = Math.Ceiling(oneP.Count / 2) - 1

'        Dim result As Decimal = 0

'        Dim cnt As Decimal = 1

'        For i As Decimal = centerP - 1 To 0 Step -1
'            result += (oneP(centerP) - cnt) - oneP(i)
'            cnt += 1
'        Next

'        cnt = 1
'        For i As Decimal = centerP + 1 To oneP.Count - 1
'            result += oneP(i) - (oneP(centerP) + cnt)
'            cnt += 1
'        Next
