...
'        Dim D As Decimal = argD(1)
'        Dim P As Decimal = argD(2)

'        Dim F As List(Of Decimal) = in_dAry().ToList
...
'            If F.Count < 1 Then Exit While

'            Dim Fsum As Decimal = 0

'            Dim s As Decimal = Math.Max(F.Count - D, 0)
'            Dim e As Decimal = F.Count - 1

'            For i As Decimal = s To e
'                Fsum += F(i)
'            Next

'            If Fsum < P Then Exit While

'            r += P

'            For i As Decimal = e To s Step -1
'                F.RemoveAt(i)
'            Next

'        End While

'        r += (Aggregate dd As Decimal In F Into Sum)
