...
'        'Dim mexDic As New HashSet(Of Decimal)
'        Dim mexDic As New SortedSet(Of Decimal)
'        Dim aCntDic As New Dictionary(Of Decimal, Decimal)

'        'Dim A As String() = in_sAry()
'        Dim argS As String() = in_sAry()
'        Dim A As New List(Of Decimal)

'        For i As Decimal = 0 To 200000
'            mexDic.Add(i)
'            'aCntDic.Add(i, 0)
'        Next
...
'            Dim tempA As Decimal = Decimal.Parse(argS(i))
'            A.Add(tempA)

'            If mexDic.Contains(tempA) Then mexDic.Remove(tempA)

'            If Not aCntDic.ContainsKey(tempA) Then aCntDic.Add(tempA, 0)
'            aCntDic(tempA) += 1
...
'            Dim befAi As Decimal = A(argD(0) - 1)
'            Dim aftAi As Decimal = argD(1)

'            A(argD(0) - 1) = aftAi

'            If Not aCntDic.ContainsKey(aftAi) Then aCntDic.Add(aftAi, 0)
'            If aCntDic(aftAi) = 0 Then mexDic.Remove(aftAi)
'            aCntDic(aftAi) += 1

'            aCntDic(befAi) -= 1
'            If aCntDic(befAi) = 0 Then mexDic.Add(befAi)

'            r.AppendLine(mexDic(0))
