...
'        Dim graph As New List(Of List(Of Decimal))
'        Dim tempL As New List(Of Decimal)
'        For i As Decimal = 0 To 100
'            tempL.Add(0)
'        Next
'        For i As Decimal = 0 To 100
'            graph.Add(New List(Of Decimal)(tempL))
'        Next

'        Dim r As Decimal = 0
'        Dim checkedCell As New HashSet(Of String)

'        For i As Decimal = 0 To N - 1
'            Dim argD As Decimal() = in_dAry()
'            For j As Decimal = argD(2) To argD(3) - 1
'                For k As Decimal = argD(0) To argD(1) - 1
'                    graph(j)(k) = 1
'                    If checkedCell.Add(j.ToString & "," & k.ToString) Then
'                        r += 1
'                    End If
'                Next
'            Next
