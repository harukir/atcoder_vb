...
'        Dim C As Decimal() = in_dAry()

'        Dim colorBystr As New Dictionary(Of Decimal, Queue(Of String))
'        Dim colorByLastStr As New Dictionary(Of Decimal, String)

'        For i As Decimal = 0 To C.Count - 1

'            If Not colorBystr.ContainsKey(C(i)) Then
'                colorBystr.Add(C(i), New Queue(Of String))
'            End If

'            colorBystr(C(i)).Enqueue(S.Substring(i, 1))
'            addDic(colorByLastStr, C(i), S.Substring(i, 1))
'        Next
...
'            If colorByLastStr.ContainsKey(C(i)) Then
'                r.Append(colorByLastStr(C(i)))
'                colorByLastStr.Remove(C(i))
'            Else
'                r.Append(colorBystr(C(i)).Dequeue)
'            End If
...
'    Sub addDic(ByRef dic As Dictionary(Of Decimal, String), ByVal key As Decimal, ByVal val As String)
