...
'        Dim stick As New List(Of String)
'        For i As Decimal = 0 To N - 1
'            stick.Add(in_s())
'        Next

'        Dim ball As New HashSet(Of String)

'        For i As Decimal = 0 To stick.Count - 1

'            If Not ball.Contains(stick(i)) AndAlso Not ball.Contains(String.Join("", stick(i).Reverse)) Then
'                ball.Add(stick(i))
'            End If
...
'        Console.WriteLine(ball.Count.ToString)
